...
# Convertir https:// a rediss:// (TLS)
if REDIS_URL.startswith("https://"):
    REDIS_URL = REDIS_URL.replace("https://", "rediss://", 1)
elif REDIS_URL.startswith("http://"):
    REDIS_URL = REDIS_URL.replace("http://", "rediss://", 1)

# Asegurar que tiene el puerto correcto
if ":70802" not in REDIS_URL:
    REDIS_URL = REDIS_URL.replace("rediss://relaxed-polecat-70802.upstash.io", "rediss://relaxed-polecat-70802.upstash.io:70802")

print(f"📋 URL corregida: {REDIS_URL}")
